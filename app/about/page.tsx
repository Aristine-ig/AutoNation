...
const missions = [
  {
    ...
    title: "Our Mission",
    description:
      "To democratize access to Automation through AI and blockchain technology, making Automation available to everyone, everywhere, at any time.",
  },
  {
    icon: <Target className="w-8 h-8 text-primary" />,
    title: "Our Vision",
    description:
      "A world where Automation is accessible, private, and personalized, powered by trusted AI agents and secured by blockchain technology.",
  },
  {
    ...
    <div className="container mx-auto px-4 py-24">
      ...
      >
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          We&apos;re revolutionizing Automation combining cutting-edge
